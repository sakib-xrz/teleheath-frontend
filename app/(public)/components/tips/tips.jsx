            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {healthTips.map((tip, index) => (
                ...
                >
                  ...
                  {/* Content */}
                  <motion.div className="relative flex h-80 flex-col justify-end p-6 text-white">
